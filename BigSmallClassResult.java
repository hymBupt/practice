...
public class BigSmallClassResult {
    ...
    private final static String searchFile="./conf/topKeyWord.txt";
    // 输出文件名称
    // 片区
    private final static String bigSmallClassStaticFileName = "大类hit无search统计.xls";
    ...
    private void initBigSmallClassStaticSheet(HSSFSheet sheet) {
        ...
        int curContentRow = 1;
        // 写入标题
        String[] titles = { "大类",  "总量" ,"无search量","无search的量占总量的比"};
        ...
        for (Area area : bigSmallClassStatics) {
            ...
            contentArr[1] = area.totalNum+"";
            contentArr[2]=area.notSearchNum+"";
           // contentArr[3] = area.notSearchNum+"";
            float percents=(float)area.notSearchNum/area.totalNum;
            NumberFormat nf=NumberFormat.getPercentInstance();
            nf.setMaximumFractionDigits(4);
            contentArr[3] = nf.format(percents); // 新增片区坐标
    ...
    public static class Area {
        ...
        public static Area polygonWithNoPoiArea(String line) {
           ...
           // String smallClassName = classArr[1];
            ...
            area.bigClassName=bigClassName;
            area.totalNum=totalNum;
            area.notSearchNum=notSearchNum;
            return area;
        }
    }
