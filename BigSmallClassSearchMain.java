...
public class BigSmallClassSearchMain {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setOutputValueClass(ReduceValue.class);

       //MultipleOutputs.addNamedOutput(job, BigSmallClassSearchReducer.itemName, GBKTextOutputFormat.class,Text.class,Text.class);
       MultipleOutputs.addNamedOutput(job, BigSmallClassSearchReducer.staticName, GBKTextOutputFormat.class,Text.class,ReduceValue.class);
